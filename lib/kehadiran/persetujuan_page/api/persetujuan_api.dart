...
class PersetujuanApi {
  ...
  Future<DataCutiModel> approveDataPengajuan({required int pengajuan_id, required String role, required String action,
    required String divisi_id, required String actor_id}) async {
